...
%\begin{figure}[H]
%\begin{center}
% \includegraphics[scale=0.6]{} % VARIABLE 
%\end{center}
...
$KMER_TREE_PATH
\end{verbatim}
 Phylogeny relatedness between reference genome of Staphylococcus sp. and genomes from this study. This phylogeny was obtained using Neighbor joining algorithm and based on distance matrix from k-mer analysis implemented in Fastosh.
