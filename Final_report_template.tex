...
\begin{tabular}{|c|c|c|}
  ...
  \hline
  \textit{05CEB51} & \textit{Food} & \today\\%########################### VARIABLE ############
  \textit{05CEB52} & \textit{Milk} & \today\\%########################### VARIABLE ############
  \hline 
\end{tabular}\\[1cm]
}}
...
\begin{tabular}{|p{2cm}|p{2cm}|c|c|}
  ...
  \hline
  \textit{05CEB51} & 5 & 2786542 & Staphylococcus\_aureus\_AJ\_938182 \\%########################### VARIABLE ############
  \textit{05CEB52} & 2 & 2586542 & Staphylococcus\_aureus\_CP\_000703 \\%########################### VARIABLE ############
  \hline 
\end{tabular}\\[1cm]
}}
...
\begin{tabular}{|c|c|c|}
  ...
  \hline
  \textit{05CEB51} & \textit{aureus} & 5 \\%########################### VARIABLE ############
  \textit{05CEB52} & \textit{aureus} & 2  \\%########################### VARIABLE ############
  \hline 
\end{tabular}\\[1cm]
}}
...
\begin{tabular}{|p{2cm}|p{8cm}|}
  ...
  \hline
  \textit{05CEB51} & seu(2), sex(2), seg(1), sec(1), seo(19), sen(1), sem(1), sel(1), sei(1), seh(1) \\%########################### VARIABLE ############
  \textit{05CEB52} & {\color{red} seo(99)}, sen(1) \\%########################### VARIABLE ############
  \hline
\end{tabular}\\
}}
